...
namespace z_engine
{
    ...
    ZSwapChain::ZSwapChain(ZDevice& deviceRef, VkExtent2D extent, std::shared_ptr<ZSwapChain> previous) :
        device_{deviceRef}, windowExtent{extent}, oldSwapChain{previous}
    {
        init();
